...
/* $Id: Source.h,v 1.13 2005/03/24 17:43:29 grosch rel $ */
...
$@ extern void $_SetEncoding ARGS ((int yyEncoding, int yyEndian));
...
$@ extern int  $_BeginSourceFile ARGS ((char * yyFileName));

   /*
$@       $_BeginSourceFile is called from the scanner function $_BeginFile
...
# if HAVE_WCHAR_T
$@ extern int  $_BeginSourceFileW ARGS ((wchar_t * yyFileName));
...
$@ extern void $_BeginSourceMemory ARGS ((void * yyInputPtr));

   /*
$@       $_BeginSourceMemory is called from the scanner function $_BeginMemory
...
$@ extern void $_BeginSourceMemoryN ARGS ((void * yyInputPtr, int yyLength));

   /*
$@       $_BeginSourceMemoryN is called from the scanner function $_BeginMemoryN
...
$@ extern void $_BeginSourceGeneric ARGS ((void * yyInputPtr));

   /*
$@       $_BeginSourceGeneric is called from the scanner function $_BeginGeneric
      indicating that the input is user-defined at location 'InputPtr'.
      The Source module has to be extended by the user in order to
      implement this feature.
   */

$@ extern int  $_GetLine ARGS ((int yyFile, char * yyBuffer, int yySize));
...
# if HAVE_WCHAR_T
$@ extern int  $_GetWLine ARGS ((int yyFile, wchar_t * yyBuffer, int yySize));
...
$@ extern void $_CloseSource ARGS ((int yyFile));

   /*
$@       $_CloseSource is called from the scanner function $_CloseFile

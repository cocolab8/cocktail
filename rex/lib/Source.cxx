...
$@ void $_SetEncoding (int Encoding, int Endian)
{
...
$@ int $_BeginSourceFile (char * FileName)
{
   PushSource ();
...
$@ int $_BeginSourceFileW (wchar_t * FileName)
{
   PushSource ();
   input_kind = input_from_file;
...
$@ void $_BeginSourceMemory (void * InputPtr)
{
...
$@ void $_BeginSourceMemoryN (void * InputPtr, int Length)
{
   PushSource ();
...
$@ void $_BeginSourceGeneric (void * InputPtr)
{
   PushSource ();
...
$@ int $_GetWLine (int File, wchar_t * Buffer, int Size)
{
   switch (input_kind) {

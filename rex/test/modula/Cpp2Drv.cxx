...
static void do_it (void * buffer, int length, char * Text)
{
   Scanner.BeginMemory (buffer);
   do_scan (Text);
   Scanner.BeginMemoryN (buffer, length);
   do_scan (Text);
}

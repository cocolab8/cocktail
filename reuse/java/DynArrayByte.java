...
/**********************************************************************
 * Only edit this file if Byte is underscore X.  If it is a Java type
...
/**
*** Dynamic flexible arrays of element type <code>byte</code>.
...
*** <P>
*** <PRE>
***      DynArrayByte list = new DynArrayByte(100);
...
*** {@link #resize(byte[],int) resize}, {@link #extend(byte[]) extend},
*** and {@link #shrink(byte[]) shrink}.  Example:
*** <P>
*** <PRE>
***      byte[] list = new byte[100];
***      list = DynArrayByte.extend(list);
***      x = list[105];
***      list[107] = x;
*** </PRE>
*** <P>
...
public class DynArrayByte implements java.io.Serializable {
    /** CVS version string. **/
    private static final java.lang.String cvsid = "$Id: DynArrayByte.java,v 1.1.1.4.2.1 1999/06/18 07:39:52 howie Exp $";
    ...
    ***            old array copied.
    ***
    *** @see #extend(byte[]) doubling the current size
    *** @see #shrink(byte[]) halving the current size
    **/
    ...
    ***            old array copied.
    ***
    *** @see #resize(byte[],int) requesting a specific size
    *** @see #shrink(byte[]) halving the current size
    **/
    public static final byte[] extend(byte[] array) {
    ...
    *** @see #resize(byte[],int) requesting a specific size
    **/
    public static final byte[] shrink(byte[] array) {

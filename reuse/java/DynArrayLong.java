...
/**********************************************************************
 * Only edit this file if Long is underscore X.  If it is a Java type
...
/**
*** Dynamic flexible arrays of element type <code>long</code>.
...
*** <P>
*** <PRE>
***      DynArrayLong list = new DynArrayLong(100);
...
*** {@link #resize(long[],int) resize}, {@link #extend(long[]) extend},
*** and {@link #shrink(long[]) shrink}.  Example:
*** <P>
*** <PRE>
***      long[] list = new long[100];
***      list = DynArrayLong.extend(list);
***      x = list[105];
***      list[107] = x;
*** </PRE>
*** <P>
...
public class DynArrayLong implements java.io.Serializable {
    /** CVS version string. **/
    private static final java.lang.String cvsid = "$Id: DynArrayLong.java,v 1.1.1.4.2.1 1999/06/18 07:39:52 howie Exp $";
    ...
    ***            old array copied.
    ***
    *** @see #extend(long[]) doubling the current size
    *** @see #shrink(long[]) halving the current size
    **/
    ...
    ***            old array copied.
    ***
    *** @see #resize(long[],int) requesting a specific size
    *** @see #shrink(long[]) halving the current size
    **/
    ...
    *** @see #resize(long[],int) requesting a specific size
    **/
    public static final long[] shrink(long[] array) {

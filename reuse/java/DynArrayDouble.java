...
/**********************************************************************
 * Only edit this file if Double is underscore X.  If it is a Java type
...
/**
*** Dynamic flexible arrays of element type <code>double</code>.
...
*** <P>
*** <PRE>
***      DynArrayDouble list = new DynArrayDouble(100);
...
*** {@link #resize(double[],int) resize}, {@link #extend(double[]) extend},
*** and {@link #shrink(double[]) shrink}.  Example:
*** <P>
*** <PRE>
***      double[] list = new double[100];
***      list = DynArrayDouble.extend(list);
***      x = list[105];
***      list[107] = x;
*** </PRE>
*** <P>
...
public class DynArrayDouble implements java.io.Serializable {
    /** CVS version string. **/
    private static final java.lang.String cvsid = "$Id: DynArrayDouble.java,v 1.1.1.4.2.1 1999/06/18 07:39:52 howie Exp $";
    ...
    ***            old array copied.
    ***
    *** @see #extend(double[]) doubling the current size
    *** @see #shrink(double[]) halving the current size
    **/
    ...
    ***            old array copied.
    ***
    *** @see #resize(double[],int) requesting a specific size
    *** @see #shrink(double[]) halving the current size
    **/
    ...
    *** @see #resize(double[],int) requesting a specific size
    **/
    public static final double[] shrink(double[] array) {
    ...
    **/
    public DynArrayDouble(int size) {

...
/**********************************************************************
 * Only edit this file if Float is underscore X.  If it is a Java type
...
/**
*** Dynamic flexible arrays of element type <code>float</code>.
...
*** <P>
*** <PRE>
***      DynArrayFloat list = new DynArrayFloat(100);
...
*** {@link #resize(float[],int) resize}, {@link #extend(float[]) extend},
*** and {@link #shrink(float[]) shrink}.  Example:
*** <P>
*** <PRE>
***      float[] list = new float[100];
***      list = DynArrayFloat.extend(list);
***      x = list[105];
***      list[107] = x;
*** </PRE>
*** <P>
...
public class DynArrayFloat implements java.io.Serializable {
    /** CVS version string. **/
    private static final java.lang.String cvsid = "$Id: DynArrayFloat.java,v 1.1.1.4.2.1 1999/06/18 07:39:52 howie Exp $";
    ...
    ***            old array copied.
    ***
    *** @see #extend(float[]) doubling the current size
    *** @see #shrink(float[]) halving the current size
    **/
    public static final float[] resize(float[] array, int newSize) {
    ...
    ***            old array copied.
    ***
    *** @see #resize(float[],int) requesting a specific size
    *** @see #shrink(float[]) halving the current size
    **/
    ...
    *** @see #resize(float[],int) requesting a specific size
    **/
    public static final float[] shrink(float[] array) {

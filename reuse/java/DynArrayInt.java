...
/**********************************************************************
 * Only edit this file if Int is underscore X.  If it is a Java type
...
/**
*** Dynamic flexible arrays of element type <code>int</code>.
...
*** <P>
*** <PRE>
***      DynArrayInt list = new DynArrayInt(100);
...
*** {@link #resize(int[],int) resize}, {@link #extend(int[]) extend},
*** and {@link #shrink(int[]) shrink}.  Example:
*** <P>
*** <PRE>
***      int[] list = new int[100];
***      list = DynArrayInt.extend(list);
***      x = list[105];
***      list[107] = x;
*** </PRE>
*** <P>
...
public class DynArrayInt implements java.io.Serializable {
    /** CVS version string. **/
    private static final java.lang.String cvsid = "$Id: DynArrayInt.java,v 1.1.1.4.2.1 1999/06/18 07:39:52 howie Exp $";
    ...
    ***            old array copied.
    ***
    *** @see #extend(int[]) doubling the current size
    *** @see #shrink(int[]) halving the current size
    **/
    ...
    ***            old array copied.
    ***
    *** @see #resize(int[],int) requesting a specific size
    *** @see #shrink(int[]) halving the current size
    **/
    ...
    *** @see #resize(int[],int) requesting a specific size
    **/
    public static final int[] shrink(int[] array) {

...
/**********************************************************************
 * Only edit this file if Char is underscore X.  If it is a Java type
...
/**
*** Dynamic flexible arrays of element type <code>char</code>.
...
*** <P>
*** <PRE>
***      DynArrayChar list = new DynArrayChar(100);
...
*** {@link #resize(char[],int) resize}, {@link #extend(char[]) extend},
*** and {@link #shrink(char[]) shrink}.  Example:
*** <P>
*** <PRE>
***      char[] list = new char[100];
***      list = DynArrayChar.extend(list);
***      x = list[105];
***      list[107] = x;
*** </PRE>
*** <P>
...
public class DynArrayChar implements java.io.Serializable {
    /** CVS version string. **/
    private static final java.lang.String cvsid = "$Id: DynArrayChar.java,v 1.1.1.4.2.1 1999/06/18 07:39:52 howie Exp $";
    ...
    ***            old array copied.
    ***
    *** @see #extend(char[]) doubling the current size
    *** @see #shrink(char[]) halving the current size
    **/
    ...
    ***            old array copied.
    ***
    *** @see #resize(char[],int) requesting a specific size
    *** @see #shrink(char[]) halving the current size
    **/
    ...
    *** @see #resize(char[],int) requesting a specific size
    **/
    public static final char[] shrink(char[] array) {

/* $Id: Source.cxx,v 1.3 2000/12/20 15:37:30 grosch rel $ */
...
static char rcsid [] =
   "$Id: Source.cxx,v 1.2 1995/03/20 15:37:30 grosch rel $";
...
# if defined _MSC_VER
#  pragma warning (disable:4100 4127 4244 4514)
# endif
...
void SetEncoding (int Encoding, int Endian)
{
...
int BeginSourceFile (char * FileName)
{
   PushSource ();
...
int BeginSourceFileW (wchar_t * FileName)
{
   PushSource ();
   input_kind = input_from_file;
...
void BeginSourceMemory (void * InputPtr)
{
...
void BeginSourceMemoryN (void * InputPtr, int Length)
{
   PushSource ();
...
void BeginSourceGeneric (void * InputPtr)
{
   PushSource ();
   input_kind = user_defined_input;
}

int GetLine (int File, char * Buffer, int Size)
{
   switch (input_kind) {
...
int GetWLine (int File, wchar_t * Buffer, int Size)
{
   switch (input_kind) {

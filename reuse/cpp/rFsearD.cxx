 ...
 * Id: rFsearD.c,v 1.35 2007/10/08 15:36:14 vollmer Exp $
 */
...
# endif
  if (rFsearchShowDebug) Print_rFsearch(stdout);
# ifdef rFsearch_UNIX
  /* find the .o file but not the executable */
  check (rFindFile ("rFsearD"),    "rFsearD.o");
...
test_dir_sets (void)
{
  ...
  check (rFindFileSet ("rFsearch.cxx", 0), "rFsearch.cxx");   /* all sets */
  check (rFindFileSet ("rFsearch.cxx", 1), NULL);           /* set 1    */
  check (rFindFileSet ("rFsearch.cxx", 2), "rFsearch.cxx");   /* set 2    */

...
typedef struct srGetoptLong {
  ...
  const char *name;     /* long name,  if 0: end of option list  */
...
extern const char *rOptoptLong;   /* the actual accepted option text */

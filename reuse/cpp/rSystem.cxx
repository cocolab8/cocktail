/* $Id: rSystem.c,v 1.50 2007/10/12 09:21:53 grosch rel grosch $ */

/*
 * $Log: rSystem.c,v $
 * Revision 1.50  2007/10/12 09:21:53  grosch
 * fixed function rDirExists - #include <windows.h>
 *
 * Revision 1.49  2005/05/23 12:26:27  grosch
 * changed #include <config.h> to #include "config.h"
 *
 * Revision 1.48  2005/05/23 10:23:07  grosch
 * fixed problem on AIX with system call write (1, p, 0)
 * changed #include <...> to #include "..."
 *
 * Revision 1.47  2005/03/24 15:04:10  grosch
 * improved support for MVS
 *
 * Revision 1.46  2004/07/06 14:39:12  grosch
 * added support for MVS
 * added functions: rDirExists, rMakeDir, fopen_inout, fopen_output
 *
 * Revision 1.45  2004/07/06 13:42:15  grosch
 * added argument to function check_license
 *
 * Revision 1.44  2002/04/15 13:06:19  grosch
 * always use binary IO
 *
 * Revision 1.43  2001/12/21 14:26:45  grosch
 * fixed compilation problem with fileno under Linux
 *
 * Revision 1.42  2000/12/29 17:00:41  grosch
 * improved function rSystem on Windows
 *
 * Revision 1.41  2000/09/04 13:49:45  grosch
 * changed # include "config.h" to <config.h>
 *
 * Revision 1.40  2000/04/10 16:07:48  grosch
 * introduced ifdef HAVE_ARGS
 * introduced if HAVE_xxx_H

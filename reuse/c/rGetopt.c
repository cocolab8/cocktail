...
static int search_long_option (char *str, trGetoptLong *options)
...
static int search_short_option (char *str, trGetoptLong *options)
...
int rGetoptLong (int argc, char *const *argv, trGetoptLong *options)
{
  ...
  case rStringArg:
    GET_OPT_ARG();
    if (options[rOptIndex].variable) {
      *((char**) options[rOptIndex].variable) = rOptarg;
    }
    nextchar = "";
    break;
  case roStringArg:

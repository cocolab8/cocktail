...
/* $Id: Source.h,v 1.9 2007/10/12 09:10:41 grosch rel $ */

/*
 * $Log: Source.h,v $
 * Revision 1.9  2007/10/12 09:10:41  grosch
 * cosmetic changes
 *
 * Revision 1.8  2005/05/23 12:26:27  grosch
 * changed #include <config.h> to #include "config.h"
 *
 * Revision 1.7  2001/01/28 15:05:29  grosch
 ...
 *
 * Revision 1.4  1998/11/16 17:19:20  grosch
 * improved comments
 *
 * Revision 1.3  1997/05/27 13:25:04  grosch
 * truncation of filenames to 8.3 format
 *
 * Revision 1.2  1997/04/08 13:38:16  grosch
...
extern void SetEncoding ARGS ((int yyEncoding, int yyEndian));
...
extern int  BeginSourceFile ARGS ((char * yyFileName));
...
# if HAVE_WCHAR_T
extern int  BeginSourceFileW ARGS ((wchar_t * yyFileName));
...
extern void BeginSourceMemory ARGS ((void * yyInputPtr));
...
extern void BeginSourceMemoryN ARGS ((void * yyInputPtr, int yyLength));
...
extern void BeginSourceGeneric ARGS ((void * yyInputPtr));
...
# if HAVE_WCHAR_T
extern int  GetWLine ARGS ((int yyFile, wchar_t * yyBuffer, int yySize));

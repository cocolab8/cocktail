...
# define readtStringRef(a)	{ char yys [1024]; fgets (yys, 1024, yyf); ungetc ('\n', yyf); a = String_PREFIX PutString (yys, strlen (yys) - 1); }
# define writetStringRef(a)	String_PREFIX WriteString (yyf, a);
# define gettStringRef(a)	{ char yys [1024]; fgets (yys, 1024, yyf); a = String_PREFIX PutString (yys, strlen (yys) - 1); }
# define puttStringRef(a)	{ String_PREFIX WriteString (yyf, a); fputc ('\n', yyf); }
...
# define puttWStringRef(a)	{ String_PREFIX WriteWString (yyf, a); fputc ('\n', yyf); }
...
# define putvtStringRef(a)	{ String_PREFIX vWriteString (yyf, a); fputc ('\n', yyf); }
...
# define gettWIdent(a)		
# define puttWIdent(a)		{ Idents_PREFIX WriteWIdent (yyf, a); fputc ('\n', yyf); }
...
# define getvtIdent(a)		
# define putvtIdent(a)		{ Idents_PREFIX vWriteIdent (yyf, a); fputc ('\n', yyf); }

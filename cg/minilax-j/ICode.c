 ...
 * Signature: (III)V
 */
JNIEXPORT void JNICALL Java_minilax_ICode_Emit
 ...
 * Signature: (IIF)V
 */
JNIEXPORT void JNICALL Java_minilax_ICode_EmitReal
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_minilax_ICode_Interpret
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_minilax_ICode_WriteCode
  (JNIEnv *jenv, jclass jcls) {
    WriteCode ();
  }
